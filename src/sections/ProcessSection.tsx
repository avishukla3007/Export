...
export default function ProcessSection() {
  ...
  return (
    <SectionWrapper id="process" className="bg-slate-900/50">
      {/* Header */}
      <motion.div
      ...
      >
        <span className="text-blue-400 font-semibold text-lg">Our Process</span>
        <h2 className="heading-md mt-4 bg-gradient-to-r from-blue-300 to-purple-400 bg-clip-text text-transparent">
          How We Deliver Excellence
        </h2>
        <p className="text-gray-400 text-lg mt-4 max-w-2xl mx-auto">
          From farm to your facility, our streamlined process ensures quality and reliability at every step.
        </p>
      </motion.div>
      ...
      <div className="relative">
        ...
        <div className="hidden lg:block absolute top-1/4 left-0 right-0 h-1 bg-gradient-to-r from-blue-500/30 via-purple-500/30 to-blue-500/30" />
      ...
      >
        <p className="text-gray-300 mb-6">Ready to experience our process?</p>
        <motion.button
