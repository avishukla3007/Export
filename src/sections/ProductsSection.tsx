  ...
  const products = [
    {
      ...
      icon: Package,
      items: ['Pure Turmeric Powder (हल्दी)', 'Green Cardamom (इलायची)', 'Dried Cumin Seeds (जीरा)', 'Black Peppercorns (काली मिर्च)', 'Dried Coriander Seeds (धनिया)', 'Dried Fenugreek Seeds (मेथी)'],
    ...
    },
    {
      ...
      icon: Leaf,
      items: ['Organic Moringa Leaf Powder (सहजन)', 'Pure Neem Leaf Powder (नीम)', 'Isabgol - Psyllium Husk (ईसबगोल)', 'Organic Ashwagandha Root Extract (अश्वगंधा)', 'Brahmi Leaf Extract (ब्राह्मी)', 'Holy Basil Powder - Tulsi (तुलसी)'],
    ...
    },
    {
      ...
      icon: TrendingUp,
      items: ['Golden Flax Seeds (अलसी)', 'White Sesame Seeds (तिल)', 'Brown Mustard Seeds (सरसों)', 'Black Chia Seeds (चिया)', 'Organic Hemp Seeds (भांग)', 'Organic Spirulina Powder (स्पिरुलिना)'],
